(() => {
            ...
            },
            {
              ...
              condition: function(node) {
                ...
                if (me.doctype && frappe.get_meta(me.doctype)) {
                  if (!frappe.get_meta(me.doctype).allow_rename)
                    allow_rename = false;
                }
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/listing.html
...
`;
  ...
  frappe.ui.FieldSelect = class FieldSelect {
    constructor(opts) {
      ...
      this.$input.on("awesomplete-select", function(e) {
        ...
        if (me.select)
          me.select(item.doctype, item.fieldname);
      });
    ...
    build_options() {
      ...
      $.each(me.table_fields, function(i, table_df) {
        if (table_df.options) {
          ...
          $.each(frappe.utils.sort(child_table_fields, "label", "string"), function(i2, df) {
            let doctype = frappe.get_meta(me.doctype).istable && me.parent_doctype ? me.parent_doctype : me.doctype;
            if (frappe.perm.has_perm(doctype, df.permlevel, "read"))
              me.add_field_option(df);
          });
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/filters/edit_filter.html
...
`;
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/html/print_template.html
...
`;
  ...
  var bulk_operations_default = BulkOperations;
  ...
  var ListSettings = class {
    ...
    set_list_view_fields(meta) {
      ...
      meta.fields.forEach((field) => {
        if (field.in_list_view && !in_list(frappe.model.no_value_type, field.fieldtype) && me.subject_field.fieldname != field.fieldname) {
          me.fields.push({
            label: field.label,
            fieldname: field.fieldname
          });
  ...
  var list_settings_default = ListSettings;
  ...
  frappe.views.ListView = class ListView extends frappe.views.BaseList {
    ...
    render_list() {
      ...
      if (this.data.length > 0) {
        this.$result.append(this.data.map((doc, i) => {
          doc._idx = i;
    ...
    get_actions_menu_items() {
      ...
      const bulk_operations = new bulk_operations_default({doctype: this.doctype});
  ...
  frappe.views.ListViewSelect = class ListViewSelect {
    ...
    setup_views() {
      const views = {
        ...
        Map: {
          condition: this.list_view.settings.get_coords_method || this.list_view.meta.fields.find((i) => i.fieldname === "latitude") && this.list_view.meta.fields.find((i) => i.fieldname === "longitude") || this.list_view.meta.fields.find((i) => i.fieldname === "location" && i.fieldtype == "Geolocation"),
    ...
    setup_kanban_boards() {
      const last_opened_kanban = frappe.model.user_settings[this.doctype]["Kanban"] && frappe.model.user_settings[this.doctype]["Kanban"].last_kanban_board;
  ...
  frappe.views.ListSidebar = class ListSidebar {
    ...
    setup_list_filter() {
      this.list_filter = new list_filter_default({
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar.html
...
`;
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar_stat.html
...
`;
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_view_permission_restrictions.html
...
`;
  ...
  frappe.views.MapView = class MapView extends frappe.views.ListView {
    ...
    get_coords() {
      ...
      } else if (cur_list.meta.fields.find((i) => i.fieldname === "latitude") && cur_list.meta.fields.find((i) => i.fieldname === "longitude")) {
  ...
  frappe.views.KanbanView.show_kanban_dialog = function(doctype, show_existing) {
    ...
    function new_kanban_dialog(kanbans, show_existing2) {
      if (dialog)
        return dialog;
      const fields = get_fields_for_dialog(kanbans.map((kanban) => kanban.name), show_existing2);
  ...
  var import_treeview = __toModule(require_treeview());
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/image_view_item_row.html
...
`;
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/photoswipe_dom.html
...
<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_board.html
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_column.html
  ...
  // frappe-html:/home/user/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_card.html
...
//# sourceMappingURL=list.bundle.U6A6COBX.js.map
