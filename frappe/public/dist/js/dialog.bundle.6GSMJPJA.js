(() => {
  ...
  frappe.ui.form.Layout = class Layout {
    ...
    make_section(df) {
      this.section = new section_default(this.current_tab ? this.current_tab.wrapper : this.page, df, this.card_layout, this);
      if (df) {
    ...
    make_tab(df) {
      this.section = null;
      let tab = new tab_default(this, df, this.frm, this.tabs_list, this.tabs_content);
...
//# sourceMappingURL=dialog.bundle.6GSMJPJA.js.map
