(() => {
  ...
  var import_vuedraggable4 = __toModule(require_vuedraggable_umd());
...
`;
  ...
  var import_vuedraggable3 = __toModule(require_vuedraggable_umd());

  // frappe/public/js/print_format_builder/Field.vue
  var import_vuedraggable2 = __toModule(require_vuedraggable_umd());

  // frappe/public/js/print_format_builder/ConfigureColumns.vue
  var import_vuedraggable = __toModule(require_vuedraggable_umd());
  var __vue_script__3 = {
...
`;
  ...
  var import_vuedraggable5 = __toModule(require_vuedraggable_umd());
  var __vue_script__8 = {
 ...
 * @license MIT
 */
//# sourceMappingURL=print_format_builder.bundle.IID7FKDT.js.map
